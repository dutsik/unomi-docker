...
health_check="$(curl -fsSL "$ELASTICSEARCH_HOST:$ELASTICSEARCH_REST_PORT/_cat/health?h=status")"
...
[ -z "$UNOMI_ELASTICSEARCH_ADDRESSES" ] && export UNOMI_ELASTICSEARCH_ADDRESSES="$ELASTICSEARCH_HOST:$ELASTICSEARCH_TRANSPORT_PORT"
